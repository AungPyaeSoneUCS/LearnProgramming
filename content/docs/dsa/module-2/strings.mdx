...
![Two Pointers Palindrome](../../..//media/dsa/two-pointers-palindrome.svg)
...
**Code: Palindrome စစ်ခြင်း**

```javascript
function isPalindrome(str) {
  let left = 0, right = str.length - 1;
  while (left < right) {
    if (str[left] !== str[right]) return false; // မတူရင် ရပ်
    left++;
    right--;
  }
  return true; // Palindrome ဖြစ်တယ်
}
...
![Palindrome Mirror](../../..//media/dsa/palindrome-mirror.svg)
...
![Sliding Window Pattern](../../..//media/dsa/sliding-window.svg)
